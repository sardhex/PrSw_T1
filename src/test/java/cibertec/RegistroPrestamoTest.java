...
class RegistroPrestamoTest {
    ...
    void testCodigoPrestamoInvalido() {
        ...
        String resultado = registro.registrar(codigoPrestamoInvalido, codigoLibro, nombreUsuario, fechaPrestamo,
                fechaDevolucion);
    ...
    void shouldReturnErrorIfBookCodeIsInvalid() {
        ...
        String resultado = registro.registrar(codigoPrestamo, codigoLibro, nombreUsuario, fechaPrestamo,
                fechaDevolucion);
